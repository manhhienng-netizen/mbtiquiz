...
interface PersonTypeEstimatorProps {
  questions: EstimatorQuestion[]
  resultSubjectLabel: string
...
export default function PersonTypeEstimator({
  questions,
  resultSubjectLabel,
  onSelectType,
  onComplete,
      ...
      <div style={cardStyle}>
        ...
        {lowConfidence ? (
          ...
          <>
            ...
            >
              Dựa trên mô tả, {resultSubjectLabel} có thể thuộc nhóm:
            </p>
        ...
        <p style={disclaimerStyle}>
          Đây là ước lượng — không phải chẩn đoán. Hỏi trực tiếp tốt hơn giả định type.
        </p>
        ...
        {question.options.map((option) => {
          ...
          return (
            ...
            >
              <input
                type="radio"
                name={`person-estimator-q-${question.id}`}
                checked={selected}
