 ...
 *
 * Mapping 16 trait cốt lõi ↔ tín hiệu từ 3 hệ thống:
 *   - MBTI (type patterns)
...
export const TRAIT_SIGNALS: TraitSignal[] = [
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    description: 'Khả năng nhìn thấy xu hướng và cơ hội trong tương lai trước khi chúng trở thành hiện thực; tư duy về bức tranh lớn.',
    mbtiSignals: {
      strongTypes: ['INTJ', 'INFJ', 'ENFJ', 'ENTP'],
      moderateTypes: ['ENTJ', 'ENFP'],
      dimension: 'NS',
      dimensionSide: 'high',
    },
    numerologySignals: {
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    mbtiSignals: {
      strongTypes: ['ENFP', 'ESTP', 'ENTP', 'ESFP', 'ESFJ'],
      moderateTypes: ['ISFP', 'INTP'],
      dimension: 'JP',
      dimensionSide: 'low',
    },
    numerologySignals: {
  ...
  // ─────────────────────────────────────────────────────────
  // 15. TACTICAL — Linh hoạt chiến thuật
  // ─────────────────────────────────────────────────────────
  {
    trait: 'tactical',
    label: 'Linh hoạt chiến thuật trong thực tế',
    description: 'Khả năng đọc tình huống nhanh, điều chỉnh hành động ngay lập tức và tìm ra giải pháp hiệu quả nhất trong điều kiện hiện có — không cần kế hoạch hoàn hảo trước.',
    mbtiSignals: {
      strongTypes: ['ESTP', 'ISTP'],
      moderateTypes: ['ESTJ', 'ENTJ', 'ESFP'],
      dimension: 'JP',
      dimensionSide: 'low',
    },
    numerologySignals: {
      strongNumbers: [8, 1, 4],
      moderateNumbers: [5, 22],
      explanation: 'Số 8 là chiến lược gia thực dụng; Số 1 hành động trước, bản năng dẫn đường; Số 4 kiên nhẫn chờ đúng thời điểm rồi thực thi chắc chắn.',
    },
    elementSignals: {
      strongElements: ['Kim', 'Hỏa'],
      moderateElements: ['Thổ'],
      batTuCan: ['Canh', 'Tân', 'Bính', 'Đinh'],
      explanation: 'Kim (Canh) là kiếm sắc — chính xác, quyết đoán. Hỏa (Bính) bùng phát nhanh và thích nghi liên tục — năng lượng phản ứng tức thời.',
    },
    growthEdge: 'Có thể thiếu kiên nhẫn với lập kế hoạch dài hạn hoặc bỏ qua hậu quả khi quá tập trung vào hành động ngay lập tức.',
    inWork: 'Xuất sắc trong khủng hoảng, sales, vận hành thực địa. Không phù hợp công việc lặp lại hoặc bureaucracy nặng.',
    inRelationship: 'Giải quyết vấn đề ngay khi thấy — cần học cách ở lại với cảm xúc thay vì nhảy vào fix ngay.',
  },

  // ─────────────────────────────────────────────────────────
  // 16. AUTHENTIC — Sống thật với bản thân
  // ─────────────────────────────────────────────────────────
  {
    trait: 'authentic',
    label: 'Sống thật và biểu đạt bản thân',
    description: 'Sự nhất quán sâu sắc giữa giá trị bên trong và hành động bên ngoài. Không thể — và không muốn — đóng vai người khác chỉ để được chấp nhận.',
    mbtiSignals: {
      strongTypes: ['ISFP', 'ESFP'],
      moderateTypes: ['INFP', 'ENFP', 'ISTP'],
      dimension: 'TF',
      dimensionSide: 'low',
    },
    numerologySignals: {
      strongNumbers: [3, 6, 9],
      moderateNumbers: [2, 11],
      explanation: 'Số 3 biểu đạt bản thân là nhu cầu sống còn; Số 6 trung thành với giá trị cốt lõi; Số 9 sống theo lý tưởng cá nhân dù không ai hiểu.',
    },
    elementSignals: {
      strongElements: ['Mộc', 'Hỏa'],
      moderateElements: ['Thủy'],
      batTuCan: ['Giáp', 'Ất', 'Bính', 'Đinh'],
      explanation: 'Mộc (Ất) mọc theo hướng ánh sáng riêng — không cần ai cho phép. Hỏa (Đinh) là ngọn nến — ánh sáng riêng tư nhưng thật, không thể giả tạo.',
    },
    growthEdge: 'Có thể quá nhạy cảm với môi trường không an toàn, dẫn đến thu mình hoặc phản ứng mạnh khi bị ép phải giả tạo.',
    inWork: 'Cần môi trường cho phép biểu đạt cá nhân — xuất sắc trong nghệ thuật, thiết kế, viết lách. Không phù hợp văn hóa corporate cứng nhắc.',
    inRelationship: 'Đối tác cảm nhận được sự chân thật hiếm có. Cần được chấp nhận hoàn toàn mới mở ra — nhưng khi mở ra, kết nối rất sâu.',
  },
]
...
export const TRAIT_TO_ARCHETYPE: Record<string, string> = {
  ...
  'visionary+intuitive_leader': 'empathetic_leader',
  'visionary+nurturing': 'empathetic_leader',

  // creative_pioneer
  'creative+adaptable': 'creative_pioneer',
  'visionary+adaptable': 'creative_pioneer',
  'creative+empathetic': 'creative_pioneer',
  'authentic+empathetic': 'creative_pioneer',
  ...
  'adaptable+nurturing': 'connector_catalyst',
  ...
  // Cặp trait mới
  'empathetic+nurturing': 'connector_catalyst',
  'tactical+analytical': 'strategic_architect',
  'analytical+tactical': 'strategic_architect',
  'tactical+resilient': 'resilient_builder',
  'authentic+creative': 'creative_pioneer',
  'creative+authentic': 'creative_pioneer',
}
...
import { GROWTH_ZONE_BY_MBTI } from './archetype-engine-data'
